...
build: prepare
	...
	./addressbook-data-converter --input_file rawdata/organization/data-gov-node-7620-source.xml --output_file output/data-gov-node-7620.json --converter org.from_data_gov_7437 --acc output/data-gov-node-7437.json
